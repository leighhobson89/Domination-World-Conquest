...
//
// See docs/archived/03-refactor-plan.md Phase 1.6 and docs/02-e2e-test-plan.md section 2.3.
...
export function installTestHooks(accessors) {
    ...
    window.__game = {
        ...
        // game does. See src/platform/scenarios.js and docs/02-e2e-test-plan.md 3.7.
