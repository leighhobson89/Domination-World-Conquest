    ...
    .then(module => {
        ...
        manualInteractionExceptions = new Map([
            [id['Fiji 2'],
                [
                    [id['Vanuatu 2'], 1],
                    [id['New Caledonia 2'], 1],
                    [id['New Caledonia 3'], 1]
                ]
            ],
            [id['Vanuatu 1'],
                [
                    [id['Fiji 1'], 1],
                    [id['Solomon Islands 6'], 1]
                ]
            ],
            [id['Vanuatu 2'],
                [
            ...
            [id['New Caledonia 1'],
                [
                    [id['King Island'], 1],
                    [id['Fraser Island'], 1],
                    [id['New Zealand North Island'], 1]
                ]
            ],
            [id['King Island'],
                [
                    [id['New Caledonia 1'], 1]
                ]
            ],
            [id['Fraser Island'],
                [
            ...
            [id['Solomon Islands 4'],
                [
                    [id['Fergusson Island'], 1],
                    [id['Papua New Guinea'], 1]
                ]
            ],
            [id['Solomon Islands 1'],
                [
                    [id['Fergusson Island'], 1],
                    [id['Papua New Guinea'], 1]
                ]
            ...
            [id['Fergusson Island'],
                [
                    [id['Solomon Islands 4'], 1],
                    [id['Solomon Islands 1'], 1]
                ]
            ],
            [id['Papua New Guinea'],
                [
            ...
            [id['Russia'],
                [
                    [id['Alaskan Islands 4'], 1]
                ]
            ],
            [id['Alaskan Islands 4'],
                [
                    [id['Russia'], 1]
                ]
            ],
            ...
            [id['Maldives 5'],
                [
                    [id['Seychelles North Island'], 1]
                ]
            ],
            [id['Seychelles North Island'],
                [
                    [id['Maldives 5'], 1]
                ]
            ],
            ...
            [id['Iceland'],
                [
                    [id['Hebridean Islands'], 1],
                    [id['Ireland'], 1]
                ]
            ],
            [id['Hebridean Islands'],
                [
                    [id['Iceland'], 1]
                ]
            ],
            ...
            [id['Bermuda'],
                [
                    [id['Grand Bahama (Bahamas)'], 1],
                    [id['United States'], 1]
                ]
            ],
            [id['Grand Bahama (Bahamas)'],
                [
                    [id['Bermuda'], 1],
                    [id['United States'], 1]
                ]
