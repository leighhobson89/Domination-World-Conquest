...
test.describe("picking a country", () => {
    test("gives the player every territory of a multi-territory country", async ({ game }) => {
        ...
        expect(expected, "United States should own several territories").toBeGreaterThan(1);

        // Alaska, not the mainland: clicking any ONE path must hand over all of them.
