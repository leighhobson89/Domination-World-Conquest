...
- **The marker swallowed the click underneath it.** It had no `pointer-events: none`, so a
  ...
  work around.
- **The plan's siege-offer rule is inverted.** [docs/02-e2e-test-plan.md](../../../docs/02-e2e-test-plan.md)
...
- **Do not assert that a besieged territory earns nothing** as though it were correct. It is
  ...
  [docs/03-known-issues.md](../../../docs/03-known-issues.md) §6, and the spec that pins it
  says so.
