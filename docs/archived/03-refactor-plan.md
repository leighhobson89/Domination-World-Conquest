...
**Companion documents:** [../01-codebase-audit.md](./01-codebase-audit.md) · [../01-game-design-document.md](../01-game-design-document.md) · [../02-e2e-test-plan.md](../02-e2e-test-plan.md)
...
5. **Characterisation tests before surgery.** Before restructuring a module, land e2e coverage
   for its functional area (see [../02-e2e-test-plan.md](../02-e2e-test-plan.md)). Otherwise the
...
tests/
  ...
  e2e/                           Playwright — see 02-e2e-test-plan.md
tools/
...
| 1.6 | **Add a test harness hook.** Behind `?e2e=1`, expose `window.__game = { state, commands, ready }` and a `window.__seedRandom(seed)` that installs a seeded `Math.random` before any module runs. | Prerequisite for [04](../02-e2e-test-plan.md) | ✅ |
...
**Harness note (see [../02-e2e-test-plan.md](../02-e2e-test-plan.md) §3.5)**
...
| Step | Action | Status |
|---|---|---|
| 2.1 | Stand up the Playwright harness exactly as specified in [../02-e2e-test-plan.md](../02-e2e-test-plan.md) §3 — config, runner, `--slow`, worker policy, fixtures. | ✅ |
...
- **Two numbers in [../02-e2e-test-plan.md](../02-e2e-test-plan.md) are wrong** and the specs
...
[../03-known-issues.md](../03-known-issues.md), which this section should be read alongside.
...
being chosen, and the reasoning is in [../03-known-issues.md](../03-known-issues.md) §4:
...
[../03-known-issues.md](../03-known-issues.md) §6. Neither is a defect to patch, and both are
...
([05](../03-known-issues.md) §2) named Phase 5.7 as its owner: CPU leaders and the AI's starting
...
[../03-known-issues.md](../03-known-issues.md) §9:
...
(cross-reference [../01-game-design-document.md](../01-game-design-document.md) §11).
...
[../03-known-issues.md](../03-known-issues.md) §10b: the posture deadlock, a fighting posture with
